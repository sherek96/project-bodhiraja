// Tests book lending rules directly, without using the frontend.
package com.pirivena_project.pirivena;

// Purpose: Tests the book lending service behavior without using the frontend.
...
class BookLendingServiceTests {
    ...
    @InjectMocks private BookLendingService service;
