...
public class PromotionService {
    ...
    @Transactional
    // Process every selected student together so a partial promotion cannot be saved.
    ...
    // Require a destination classroom only for outcomes that continue enrollment.
    ...
    // Translate the decision into enrollment and student status updates.
    ...
    // Store the attendance snapshot used when the decision was made.
    ...
    // Store the examination snapshot used when the decision was made.
