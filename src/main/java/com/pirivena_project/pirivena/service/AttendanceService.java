...
// Purpose: Contains the business rules for attendance operations.
...
public class AttendanceService {
    ...
    @Transactional
    // Validate the complete sheet first, then save it as one database transaction.
    ...
    // Load the saved attendance for one classroom on one day.
