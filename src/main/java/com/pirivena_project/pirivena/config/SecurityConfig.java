    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/funding-pools/**", "/api/incomes/**", "/api/expenses/**", "/api/donors/**", "/api/income-categories/**", "/api/expense-categories/**").hasAnyRole("ADMIN", "PRINCIPAL")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/events/**", "/api/event-categories/**", "/api/event-statuses/**").hasAnyRole("ADMIN", "PRINCIPAL", "VICEPRINCIPAL", "TEACHER", "LIBRARIAN", "STUDENT")
                        .requestMatchers("/api/events/**", "/api/event-categories/**", "/api/event-statuses/**").hasAnyRole("ADMIN", "PRINCIPAL", "VICEPRINCIPAL")
